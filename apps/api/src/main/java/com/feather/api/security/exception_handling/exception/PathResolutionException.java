...
public class PathResolutionException extends RuntimeException {
    ...
    public enum ErrorType {
        ...
        EMPTY_PATH_VALUE("The mapping annotation '%s' in method '%s' does not have a valid path value. Ensure it is properly configured with a non-empty path."),
        ...
        VALUE_ACCESS_ERROR("Unable to access the value from %s annotation in method '%s'. Check if the annotation is properly configured with a valid path value."),
